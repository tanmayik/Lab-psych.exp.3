...
expName = 'lab psych tut 3'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tanmayikalapatapu/Downloads/lab psych tut 3_lastrun.py',
